 ...
 * @author Admin
 */
@WebServlet(name = "UpdateSaleNoteController", urlPatterns = {"/sale/order/updatenote"})
public class UpdateSaleNoteController extends BaseAuthController {
    ...
    protected void processPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            orderDB.updateSaleNote(orderid, note);
            Gson gson = new GsonBuilder().setPrettyPrinting().create();
            JsonObject json = new JsonObject();
