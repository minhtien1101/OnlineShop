                                        ...
                                        <form action="#" method="post">
                                            ...
                                            <div class="clearfix">
                                                ...
                                                <a class="btn btn-link btn-icon fa fa-location-arrow"
                                                   ...
                                                   title=""></a>
                                                <a class="btn btn-link btn-icon fa fa-camera"
                                    ...
                                    <ul class="media-list">
                                        <li class="media">
                                            <a href="#" class="pull-left">
                                                <img src="img/26115.jpg" alt="Avatar" class="img-circle" width="64"
                                                     height="64">
                                            </a>
                                            <div class="media-body">
                                                ...
                                                <p>
                                                    In hac <a href="#">habitasse</a> platea dictumst. Proin ac nibh rutrum
                                                    lectus rhoncus eleifend.
